...
const ARTICLES_DB = {
    "real-madrid-midfield-analysis": {
        ...
        content: `
            <p>يمثل خط الوسط في كرة القدم الحديثة العمود الفقري والقلب النابض لأي مشروع فني يطمح للمنافسة على أعلى المستويات. وفي النادي الملكي ريال مدريد، لا تعتبر المنطقة الوسطى مجرد مركز لتوزيع اللعب، بل هي المساحة التي بُنيت عليها أمجاد النادي الأوروبية واستمراريته على عرش القارة العجوز خلال العقد الأخير. مع التحول التكتيكي الكبير ورحيل عناصر التاريخ السلسة (كاسيميرو، توني كروس)، واقتراب نهاية حقبة لوكا مودريتش، يخوض ريال مدريد تجربة إعادة بناء شاملة لخط وسطه، تعتمد على قوة بدنية هائلة، سرعة افتكاك عالية، ومهارات مركبة تحاول الجمع بين الصلابة الدفاعية والعمق الهجومي قبل خوض غمار الأدوار الإقصائية الحاسمة في دوري أبطال أوروبا.</p>

            <h2>1. الإرث التكتيكي: من الثلاثية التاريخية (KCM) إلى الجيل الجديد</h2>
            <p>لتفهم الوضع الحالي لخط وسط ريال مدريد، يجب أولاً العودة إلى البنية التكتيكية التي سيطرت على إفريقيا وأوروبا لسنوات طويلة. الثلاثي كاسيميرو، كروس، ومودريتش (KCM) لم يكن مجرد ثلاثة لاعبين ممتازين، بل كان منظومة متكاملة تخضع لهرمية تكتيكية واضحة:</p>
            <ul>
                <li><strong>كاسيميرو:</strong> التغطية الدفاعية الصارمة، الافتكاك في الثلث الأخير، وقتل المرتدات قبل وصولها لمربّع العمليات.</li>
                <li><strong>توني كروس:</strong> ضبط إيقاع المباراة (Tempo)، التمرير بنسبة نجاح تفوق 94%، والتحكم بالكرة تحت أشد أنواع الضغط.</li>
                <li><strong>لوكا مودريتش:</strong> كسر الخطوط بالدوران والتمرير البيني، الخروج بالكرة من المساحات الضيقة، والربط بين الوسط والهجوم.</li>
            </ul>
            <p>رحيل هؤلاء النجوم فرض على الإيطالي كارلو أنشيلوتي البحث عن فلسفة جديدة. التحول لم يكن اختياراً بل فرضته طبيعة الخصائص البدنية والفنية للاعبين الجدد، حيث انتقل الفريق من "السيطرة عبر التمرير الهادئ" إلى "السيطرة عبر الحدة البدنية والتحولات السريعة".</p>

            <h2>2. الأدوار التكتيكية الفردية لرباعي الوسط الحالي</h2>
            <p>يعتمد ريال مدريد اليوم على رباعي خيارات شاب يُعتبر الأعلى قيمة سوقية وفنية في أوروبا، ولكل لاعب منهم وظيفة تكتيكية محددة داخل المنظومة:</p>

            <h3>أ) فيدي فالفيردي: المحرك والمنظّم البدني</h3>
            <p>لا يمكن اختصار فيدي فالفيردي في كونه مجرد لاعب وسط يركض كثيراً. الأوروغوياني هو الصمام الذي يوازن الخط التكتيكي بأكمله. يتميز بقدرة خيالية على قطع مسافات شاسعة (تتجاوز 11 كيلومتراً في المباراة)، والربط بين الجبهة اليمنى ووسط الملعب. في الحالة الدفاعية، يغطي فالفيردي المساحة الخلفية عند تقدم الظهير الأيمن، وفي الحالة الهجومية يمثل خياراً للتسديد القوي من خارج المنطقة أو إرسال العرضيات السريعة.</p>

            <h3>ب) أوريلين تشواميني: صمام الأمان والارتكاز الدفاعي</h3>
            <p>يلعب تشواميني دور لاعب الارتكاز الصريح (رقم 6). مهمته الرئيسية هي اعتراض الكرات الطولية، التغلب في الثنائيات الهوائية، ومنح قلب الدفاع التغطية اللازمة عند المرتدات. التحدي الأكبر الذي يواجه تشواميني ليس في الجانب البدني، بل في سرعة اتخاذ القرار بالكرة تحت ضغط الفرق القوية في دوري الأبطال.</p>

            <h3>ج) إدواردو كامافينغا: جوكر المقاومة للضغط (Press Resistance)</h3>
            <p>يمتلك كامافينغا مهارة فريدة تتمثل في الدوران بالكرة افتكاكاً وافتكاساً تحت ضغط مهاجمي الخصم. قدرته على المرور بجسده من المساحات المغلقة تجعله خياراً مثالياً للخروج بالكرة من المناطق الخلفية. مرونته التكتيكية تسمح لأنشيلوتي بتوظيفه كارتكاز أو كظهير أيسر وهمي في المباريات الكبرى.</p>

            <h3>د) جود بيلينغهام: المهاجم الخفي ورابط الخطوط</h3>
            <p>منذ وصوله من بروسيا دورتموند، أحدث بيلينغهام ثورة في الخط الهجومي للنادي الملكي. بتوظيفه في مركز 10 المتقدم أو كـ (Free 8)، يستغل بيلينغهام المساحات المتولدة من تحركات فينيسيوس ورودريغو للتوغل في منطقة الجزاء. ذكاؤه في التموقع بدون كرة يجعله الهداف الأول والمحرك الأساسي للهجمات المعقدة.</p>

            <h2>3. الرسم التكتيكي: بين الـ 4-4-2 الماسية والـ 4-3-3 الهجينة</h2>
            <p>أنشيلوتي أظهر مرونة تكتيكية كبيرة في معالجة غياب صانع ألعاب كلاسيكي مثل كروس. الفريق يتبدل شكله بين حالتين أساسيتين خلال الـ 90 دقيقة:</p>
            <ul>
                <li><strong>في حالة الامتلاك والتحول (4-4-2 Diamond):</strong> ينزل تشواميني بين المدافعين لبناء اللعب، يتوسع فالفيردي وكامافينغا على الأطراف، بينما يتواجد بيلينغهام خلف المهاجمين مباشرة لخلق كثافة عددية في العمق.</li>
                <li><strong>في الحالة الدفاعية (4-4-2 Flat):</strong> يعود بيلينغهام لتغطية الجناح الأيسر، ويتكتل الثلاثي (تشواميني، فالفيردي، كامافينغا) في الوسط لإغلاق التمريرات البينية وتطبيق الضغط العكسي اللحظي.</li>
            </ul>

            <h2>4. التحديات الكبرى أمام مواجهة عمالقة أوروبا</h2>
            <p>رغم القوة الهائلة لخط وسط ريال مدريد، إلا أنه يواجه نقاط ضعف تكتيكية قد تستغلها فرق بحجم مانشستر سيتي، بايرن ميونخ، أو أرسنال في دوري الأبطال:</p>
            <p><strong>1) غياب التمرير الكاسر للخطوط (Line-Breaking Passes):</strong> بدون لاعب يمتلك رؤية توني كروس، يعاني الفريق أحياناً أمام الفرق التي تطبق دفاعاً منخفضاً جداً (Low Block)، حيث يصبح التمرير عرضياً وبطيئاً دون اختراق حقيقي للعمق.</p>
            <p><strong>2) إدارة الإيقاع وتبريد اللعب:</strong> الجيل الحالي يميل دائماً للسرعة والركض، مما يجعل المباراة مفتوحة وسريعة (Box-to-Box). في القمم الأوروبية، تحتاج أحياناً لتبريد المباراة والاحتفاظ بالكرة لتهدئة حماس الخصم، وهو الدور الذي يستدعي فيه أنشيلوتي خبرة لوكا مودريتش في الشوط الثاني.</p>

            <h2>5. الخلاصة والتوقعات القارية</h2>
            <p>خط وسط ريال مدريد يمر بمرحلة نضج سريعة وباهرة. القوة البدنية، السرعة، والشباب متوفرون بكثرة، لكن الاختبار الحقيقي في دوري أبطال أوروبا سيكون مدى قدرة هذا الخط على الحفاظ على التركيز الذهني والهدوء التكتيكي في المواجهات الحاسمة التي تُحسم بتفاصيل مجهرية صغيرة.</p>
        `
    },
